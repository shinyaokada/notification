const COMPANY_NAME = 'オックスフォードパートナーズ'; // 会社名を定義
...
const EMAIL_CONFIGS = [
  ...
  { 
    ...
    loginaddress : 'hr225517',
    password : 'yuruyuru0404',
  },
  { 
    name : 'Direct type',
    ...
    loginaddress : '46489/recruit@yuruyuru.co.jp',
    password : 'yryr4@18',
  },
  { 
    name : 'EN転職',
    ...
    loginaddress:'ENS339211',
    password : 'yuruyuru@2504',
  },
  { 
    name : "EN転職",
    email: 'support@employment.en-japan.com', 
...
const CHAT_WEBHOOK_URL = 'https://chat.googleapis.com/v1/spaces/AAQAZAQQ6m0/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=lFAZmSANBntqfPziO4GF58IM7T093G5mJUIrjfT9wKI';
