...
function createConfigSpreadsheet() {
  ...
  // 基本設定のヘッダーとデフォルト値（エンジニアファースト用に更新）
  const basicData = [
    ['項目名', '値'],
    ['会社名', 'エンジニアファースト'],
    ['Chat Webhook URL', 'https://chat.googleapis.com/v1/spaces/AAAAkJ8aoxk/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=XZhh1uo_Olo9pm_EdxnjXuNfRBHVpc4ChTBngiFj2Qc'],
    ['応募管理シート名', '求人応募管理シート'],
  ...
  // デフォルトの求人サイト設定（エンジニアファースト用）
  const siteData = [
    ['マイナビ', 'mt.customer@mynavi.jp', '応募受付', '・応募者への連絡は、応募管理システムMIWSの「応募管理」または「メッセージ」をご利用ください。', '応募データの詳細は、下記手順にてご確認ください。', 'xdu34', 'first0125*'],
    ['type', 'noreply@notification.type.jp', '応募がありました', '新しい応募がありましたので、お知らせいたします。', '応募者とのやり取りは「即レスポンス」が大切です。', 'hr221965', 'ef3333ses'],
    ['Direct type', 'cl-info@directtype.jp', '新着の応募', 'いつもお世話になっております。Direct type事務局です。', 'ＮＧの場合であっても、必ずご返信いただきますようお願い申し上げます。', '44887/recruit@engineer-first.co.jp', 'ef3333ses'],
    ['Direct type', 'cl-info@directtype.jp', '応募者対応のお願い', '引き続きご対応をお願いしたく、改めてご連絡を差し上げております。', '-------------------------------------------------', '44887/recruit@engineer-first.co.jp', 'ef3333ses'],
    ['EN転職', 'support@employment.en-japan.com', '新着応募のお知らせ', '下記URLより、応募者の詳細情報をご確認ください。', '※ 応募者対応の早さは、貴社の採用活動を有利にします。', 'ENS961169', 'dx8888ses'],
    ['EN転職', 'support@employment.en-japan.com', '「気になる」', '人事ご担当者様', '※気になる企業からの 『会ってみたい』 は、通常の５倍の反応率※', 'ENS961169', 'dx8888ses'],
    ['エンゲージ', 'system@en-gage.net', '新着応募のお知らせ', '下記URLより、応募内容をご確認の上、ご対応をお願いします。', 'ご不明点は、', 'ENS961169', 'dx8888ses'],
    ['ヤギオファー', 'noreply_yagi@yagish.jp', 'オファーを送った', 'オファーを送った求職者', '詳細へ', 'データなし', 'データなし'],
